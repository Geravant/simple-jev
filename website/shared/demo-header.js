...
class SimpleJevDemoHeader extends HTMLElement {
  connectedCallback() {
    ...
    this.attachShadow({mode:'open'}).innerHTML = `
      ...
      <header><div class="identity"><a class="brand" href="/index.html" aria-label="Simple Jev home"><img src="/assets/simple-jev.png" alt=""/><span>Simple Jev</span></a><a class="built-by" href="https://featherless.ai/" aria-label="Built by Featherless.ai"><span>Built by</span><img src="/assets/featherless.png" alt="Featherless.ai"/></a></div><nav aria-label="Demo navigation"><a href="/demos.html">Cool demos</a><a href="/index.html#how-it-works">How it works</a><a href="/playground.html">Playground</a><a class="docs" href="/docs.html">API docs</a></nav></header>`;
