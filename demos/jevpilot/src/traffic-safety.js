...
export function followingGap(vehicle, other) {
  ...
  // Bumper-to-bumper spacing: leave room at a standstill and add one
  // second of headway while moving. Used by both planning and live braking.
  return (other?.type === "motorcycle" ? 5 : 4) + speed;
}
